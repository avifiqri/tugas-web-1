<?php include_once "header.php" ?>	
					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								<h1 class="homepage-three-title">Outstanding <span>Product</span> </h1>
								<h2>With Glorie Store life is easy <br>you can serch all product & your needs. </h2>
								<div class="slider-content-btn">
									<a class="button btn btn-light btn-radius btn-brd" href="profil.php">Read More</a>
									<a class="button btn btn-light btn-radius btn-brd" href="follow.php">Contact</a>
								</div>
							</div>
						</div>
					</div>
    ...
    <div id="about" class="section wb">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>About Us</h4>
                        <h2>Welcome to Golden Store </h2>
                        <p class="lead">Kami Adalah Penjual Dengan Barang Yang Berkualitas Tinggi</p>
                        <p> Produk Kami Banyak Di Pasarkan Sampai Ke luar Negri  </p>

                        <a href="Profil" class="btn btn-light btn-radius btn-brd grd1">Learn More</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->

                <div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="./goodweb/uploads/about_01.jpg" alt="" class="img-responsive img-rounded">
            ...
            <div class="row">
				<div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="./goodweb/uploads/about_02.jpg" alt="" class="img-responsive img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
                ...
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>Who We are</h4>
                        <h2>We Are Golden Stories</h2>
                        <p class="lead">Bergerak Dalam Bidang Segala Bentuk Kebutuhan Sekunder Anda</p>

                        <p>Kami Membantu Anda Menemukan Barang Yang Anda Dambakan Selama ini</p>

                        <a href="follow.php" class="btn btn-light btn-radius btn-brd grd1">Learn More</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
            </div><!-- end row -->
        </div><!-- end container -->
	...
	<div class="parallax section parallax-off" data-stellar-background-ratio="0.9" style="background-image:url('./goodweb/uploads/th3.jpg');">
        <div class="container">
    ...
    <div id="services" class="parallax section lb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p class="lead">Mampu Menyediakan Barang Yang Berkualitas Dengan Kualitas Yang Terjamin</p>
            </div><!-- end title -->

            <div class="owl-services owl-carousel owl-theme">
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="./goodweb/uploads/service_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="./goodweb/uploads/service_01.jpg" alt="" class="img-responsive img-rounded">
                    </div>
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="./goodweb/uploads/service_02.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="./goodweb/uploads/service_02.jpg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="./goodweb/uploads/service_03.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="./goodweb/uploads/service_03.jpg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="./goodweb/uploads/service_04.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="./goodweb/uploads/service_04.jpg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
